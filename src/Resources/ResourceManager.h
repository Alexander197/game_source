...
private:
	...
	typedef std::map<const std::string, std::shared_ptr<Renderer::ShaderProgram>> ShaderProgramsMap_t;
	ShaderProgramsMap_t m_shaderProgramsMap;

	typedef std::map<const std::string, std::shared_ptr<Renderer::Texture2D>> TexturesMap_t;
	TexturesMap_t m_textures;

	typedef std::map<const std::string, std::shared_ptr<Renderer::Sprite>> SpritesMap_t;
	SpritesMap_t m_sprites;

	typedef std::map<const std::string, std::shared_ptr<Renderer::AnimatedSprite>> AnimatedSpritesMap_t;
	AnimatedSpritesMap_t m_animatedSprites;
